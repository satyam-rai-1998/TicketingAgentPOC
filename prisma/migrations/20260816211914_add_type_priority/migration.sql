...
INSERT INTO "new_tickets" ("assignee", "channel", "classification_result", "compliance_status", "confidence_score", "created_at", "description", "flag_type", "group_name", "id", "requester_email", "requester_name", "status", "subject", "tags", "updated_at") SELECT "assignee", "channel", "classification_result", "compliance_status", "confidence_score", "created_at", "description", "flag_type", "group_name", "id", "requester_email", "requester_name", "status", "subject", "tags", "updated_at" FROM "tickets";
DROP TABLE "tickets";
